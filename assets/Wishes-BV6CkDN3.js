 ...
 */const Xl=function(e){const t=[];let n=0;for(let r=0;r<e.length;r++){let s=e.charCodeAt(r);s<128?t[n++]=s:s<2048?(t[n++]=s>>6|192,t[n++]=s&63|128):(s&64512)===55296&&r+1<e.length&&(e.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(e.charCodeAt(++r)&1023),t[n++]=s>>18|240,t[n++]=s>>12&63|128,t[n++]=s>>6&63|128,t[n++]=s&63|128):(t[n++]=s>>12|224,t[n++]=s>>6&63|128,t[n++]=s&63|128)}return t},$p=function(e){const t=[];let n=0,r=0;for(;n<e.length;){const s=e[n++];if(s<128)t[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=e[n++];t[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=e[n++],o=e[n++],a=e[n++],l=((s&7)<<18|(i&63)<<12|(o&63)<<6|a&63)-65536;t[r++]=String.fromCharCode(55296+(l>>10)),t[r++]=String.fromCharCode(56320+(l&1023))}else{const i=e[n++],o=e[n++];t[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|o&63)}}return t.join("")},Yl={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<e.length;s+=3){const i=e[s],o=s+1<e.length,a=o?e[s+1]:0,l=s+2<e.length,c=l?e[s+2]:0,u=i>>2,h=(i&3)<<4|a>>4;let d=(a&15)<<2|c>>6,f=c&63;l||(f=64,o||(d=64)),r.push(n[u],n[h],n[d],n[f])}return r.join("")},encodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray(Xl(e),t)},decodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):$p(this.decodeStringToByteArray(e,t))},decodeStringToByteArray(e,t){this.init_();const n=t?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<e.length;){const i=n[e.charAt(s++)],a=s<e.length?n[e.charAt(s)]:0;++s;const c=s<e.length?n[e.charAt(s)]:64;++s;const h=s<e.length?n[e.charAt(s)]:64;if(++s,i==null||a==null||c==null||h==null)throw new Bp;const d=i<<2|a>>4;if(r.push(d),c!==64){const f=a<<4&240|c>>2;if(r.push(f),h!==64){const E=c<<6&192|h;r.push(E)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let e=0;e<this.ENCODED_VALS.length;e++)this.byteToCharMap_[e]=this.ENCODED_VALS.charAt(e),this.charToByteMap_[this.byteToCharMap_[e]]=e,this.byteToCharMapWebSafe_[e]=this.ENCODED_VALS_WEBSAFE.charAt(e),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[e]]=e,e>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(e)]=e,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(e)]=e)}}};class Bp extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Up=function(e){const t=Xl(e);return Yl.encodeByteArray(t,!0)},rs=function(e){return Up(e).replace(/\./g,"")},jp=function(e){try{return Yl.decodeString(e,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xe=new ec("@firebase/app"),Am="@firebase/app-compat",Rm="@firebase/analytics-compat",bm="@firebase/analytics",Cm="@firebase/app-check-compat",Sm="@firebase/app-check",Pm="@firebase/auth",xm="@firebase/auth-compat",Dm="@firebase/database",Vm="@firebase/database-compat",Nm="@firebase/functions",km="@firebase/functions-compat",Mm="@firebase/installations",Om="@firebase/installations-compat",Lm="@firebase/messaging",Fm="@firebase/messaging-compat",$m="@firebase/performance",Bm="@firebase/performance-compat",Um="@firebase/remote-config",jm="@firebase/remote-config-compat",qm="@firebase/storage",zm="@firebase/storage-compat",Wm="@firebase/firestore",Hm="@firebase/firestore-compat",Km="firebase",Gm="10.8.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{constructor(t,n){this.previousValue=t,n&&(n.sequenceNumberHandler=r=>this.se(r),this.oe=r=>n.writeSequenceNumber(r))}se(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.oe&&this.oe(t),t}}Do._e=-1;function Bs(e){return e==null}function fs(e){return e===0&&1/e==-1/0}function M_(e){return typeof e=="number"&&Number.isInteger(e)&&!fs(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{constructor(t,n="asc"){this.field=t,this.dir=n}}function $_(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bt="WebChannelConnection";class hv extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.fo=r+"://"+n.host,this.po=`projects/${s}/databases/${i}`,this.yo=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get wo(){return!1}So(n,r,s,i,o){const a=pi(),l=this.bo(n,r.toUriEncodedString());A("RestConnection",`Sending RPC '${n}' ${a}:`,l,s);const c={"google-cloud-resource-prefix":this.po,"x-goog-request-params":this.yo};return this.Do(c,i,o),this.Co(n,l,c,s).then(u=>(A("RestConnection",`Received RPC '${n}' ${a}: `,u),u),u=>{throw wn("RestConnection",`RPC '${n}' ${a} failed with error: `,u,"url: ",l,"request:",s),u})}vo(n,r,s,i,o,a){return this.So(n,r,s,i,o)}Do(n,r,s){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+On}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>n[o]=i),s&&s.headers.forEach((i,o)=>n[o]=i)}bo(n,r){const s=cv[n];return`${this.fo}/v1/${r}:${s}`}terminate(){}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Co(t,n,r,s){const i=pi();return new Promise((o,a)=>{const l=new __;l.setWithCredentials(!0),l.listenOnce(m_.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case di.NO_ERROR:const u=l.getResponseJson();A(Bt,`XHR for RPC '${t}' ${i} received:`,JSON.stringify(u)),o(u);break;case di.TIMEOUT:A(Bt,`RPC '${t}' ${i} timed out`),a(new C(p.DEADLINE_EXCEEDED,"Request time out"));break;case di.HTTP_ERROR:const h=l.getStatus();if(A(Bt,`RPC '${t}' ${i} failed with status:`,h,"response text:",l.getResponseText()),h>0){let d=l.getResponseJson();Array.isArray(d)&&(d=d[0]);const f=d==null?void 0:d.error;if(f&&f.status&&f.message){const E=function(y){const I=y.toLowerCase().replace(/_/g,"-");return Object.values(p).indexOf(I)>=0?I:p.UNKNOWN}(f.status);a(new C(E,f.message))}else a(new C(p.UNKNOWN,"Server responded with status "+l.getStatus()))}else a(new C(p.UNAVAILABLE,"Connection failed."));break;default:k()}}finally{A(Bt,`RPC '${t}' ${i} completed.`)}});const c=JSON.stringify(s);A(Bt,`RPC '${t}' ${i} sending request:`,s),l.send(n,"POST",c,r,15)})}Fo(t,n,r){const s=pi(),i=[this.fo,"/","google.firestore.v1.Firestore","/",t,"/channel"],o=f_(),a=p_(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(l.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Do(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const u=i.join("");A(Bt,`Creating RPC '${t}' stream ${s}: ${u}`,l);const h=o.createWebChannel(u,l);let d=!1,f=!1;const E=new uv({lo:y=>{f?A(Bt,`Not sending because RPC '${t}' stream ${s} is closed:`,y):(d||(A(Bt,`Opening RPC '${t}' stream ${s} transport.`),h.open(),d=!0),A(Bt,`RPC '${t}' stream ${s} sending:`,y),h.send(y))},ho:()=>h.close()}),w=(y,I,S)=>{y.listen(I,b=>{try{S(b)}catch(v){setTimeout(()=>{throw v},0)}})};return w(h,Wr.EventType.OPEN,()=>{f||A(Bt,`RPC '${t}' stream ${s} transport opened.`)}),w(h,Wr.EventType.CLOSE,()=>{f||(f=!0,A(Bt,`RPC '${t}' stream ${s} transport closed`),E.Vo())}),w(h,Wr.EventType.ERROR,y=>{f||(f=!0,wn(Bt,`RPC '${t}' stream ${s} transport errored:`,y),E.Vo(new C(p.UNAVAILABLE,"The operation could not be completed")))}),w(h,Wr.EventType.MESSAGE,y=>{var I;if(!f){const S=y.data[0];rt(!!S);const b=S,v=b.error||((I=b[0])===null||I===void 0?void 0:I.error);if(v){A(Bt,`RPC '${t}' stream ${s} received error:`,v);const V=v.status;let x=function($){const z=pt[$];if(z!==void 0)return Mu(z)}(V),T=v.message;x===void 0&&(x=p.INTERNAL,T="Unknown error status: "+V+" with message "+v.message),f=!0,E.Vo(new C(x,T)),h.close()}else A(Bt,`RPC '${t}' stream ${s} received:`,S),E.mo(S)}}),w(a,g_.STAT_EVENT,y=>{y.stat===Ga.PROXY?A(Bt,`RPC '${t}' stream ${s} detected buffering proxy`):y.stat===Ga.NOPROXY&&A(Bt,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{E.Ro()},0),E}}function mi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
